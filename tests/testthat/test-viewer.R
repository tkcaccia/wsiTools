...
test_that("interactive viewer writes a self-contained HTML file for mock slides", {
  ...
  expect_match(html, "unique_name:true", fixed = TRUE)
  ...
  expect_match(html, "#workspacePanel{position:fixed;left:12px;top:84px", fixed = TRUE)
  ...
  expect_match(html, "function workspacePanelSafeTop(){return innerWidth<=900?92:84;}", fixed = TRUE)
