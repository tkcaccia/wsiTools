...
test_that("interactive viewer writes a self-contained HTML file for mock slides", {
  ...
  expect_match(html, "seuratSpotOpacityHelp", fixed = TRUE)
  expect_match(html, "id=\"seuratSpotOpacityHelp\" type=\"button\" aria-label=\"Spot size help\"", fixed = TRUE)
  expect_match(html, "showSeuratSpotOpacityHelp", fixed = TRUE)
  ...
  expect_match(html, "seuratTileHelp", fixed = TRUE)
  expect_match(html, "id=\"seuratTileHelp\" type=\"button\" aria-label=\"Spot-centred tile help\"", fixed = TRUE)
  expect_match(html, "showSpatialTileHelp", fixed = TRUE)
...
test_that("tiled viewer HTML uses OpenSeadragon with an overlay canvas", {
  ...
  expect_match(html, "This image is already displayed in another multi-view pane", fixed = TRUE)
  expect_match(html, "Duplicate multi-view image was not opened", fixed = TRUE)
