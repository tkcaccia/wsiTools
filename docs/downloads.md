...
| --- | --- | --- |
| macOS Apple Silicon | `wsiTools-Desktop_0.1.5_macos_ARM64.dmg` | For Apple Silicon Macs. Unsigned builds may need right-click -> Open. |
| Windows x64 | `wsiTools-Desktop_0.1.5_windows_x64-setup.exe` | NSIS installer for Windows 10/11 x64. |
| Ubuntu/Debian x64 | `wsiTools-Desktop_0.1.5_linux_amd64.deb` | Install with `sudo apt install ./file.deb`. |
| Fedora/RHEL-style x86_64 | `wsiTools-Desktop_0.1.5_linux_x86_64.rpm` | Install with your RPM package manager. |
| Linux x86_64 portable | `wsiTools-Desktop_0.1.5_linux_x86_64.AppImage` | Make executable and run without installing a package. |
