...
the left-side project panel, add ordinary browser-readable images, or save/open
a browser project JSON containing the visible project images, section-specific
annotations, and trajectories. Large WSI, CZI, SVS, OME-TIFF, and pyramidal
images should still be opened from R or prepared as tiled project sources; the
project file preserves their paths/tile metadata rather than copying full pixel
data into R memory. These menus group pan/select modes, fit and
